        ...
        <div className="space-y-8">
           <Card>
            ...
            <CardContent className="space-y-4">
                 <Button variant="outline" className="w-full justify-start gap-3"><BookOpen className="text-gradient"/> Documentation Hub</Button>
                 <Button variant="outline" className="w-full justify-start gap-3"><Bot className="text-gradient"/> Chat with our AI Assistant</Button>
            </CardContent>
           </Card>
