    ...
    <div className="flex flex-col">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="space-y-20">
          ...
          <section id="board-of-directors" className="text-center">
               <h2 className="text-3xl font-bold font-headline mb-2 flex items-center justify-center gap-4"><Users className="h-8 w-8 text-primary" /> Our Board of Directors</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {boardMembers.map((member) => (
                  <Card key={member.name} className="text-center p-6 hover:shadow-xl transition-shadow flex flex-col">
          ...
          <section id="board-of-advisers" className="text-center">
               <h2 className="text-3xl font-bold font-headline mb-2 flex items-center justify-center gap-4"><Users className="h-8 w-8 text-primary" /> Our Board of Advisers</h2>
          ...
          <section id="technical-team" className="text-center">
               <h2 className="text-3xl font-bold font-headline mb-2 flex items-center justify-center gap-4"><HardHat className="h-8 w-8 text-primary" /> Staff & Technical Team</h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
                {technicalTeam.map((member, index) => (
                  <Card key={`${member.name}-${index}`} className="text-center p-6 hover:shadow-xl transition-shadow flex flex-col items-center">
                      <CardHeader className="p-0">
                        <CardTitle className="text-xl">{member.name}</CardTitle>
          ...
          <section id="marketing-executive-team" className="text-center">
               <h2 className="text-3xl font-bold font-headline mb-2 flex items-center justify-center gap-4"><MapPin className="h-8 w-8 text-primary" /> District Office and Marketing Executive</h2>
