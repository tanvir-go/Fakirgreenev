...
import { Target, Eye, History, Handshake, BadgeCheck, Leaf, Lightbulb, Check, HardHat, Users, Focus, TrendingUp, Scale, Building, Camera, UserCheck, ChevronRight } from "lucide-react";
...
const affiliations = [
    "Bangladesh Solar & Renewable Energy Association (BSREA)",
...
const companyInfo = [
    ...
    { label: "Cost of Land and Infrastructure", value: "The premises consist of a six-story building with 1,500 square feet per floor (totaling 9,000 square feet) and an additional 10,000 square feet of steel-fabricated shed. Total Cost: BDT 5 Crore." },
    { label: "Cost of Machineries and Equipment", value: "Total Cost: BDT 1.5 Crore" },
    { label: "Total Project Cost", value: "Estimated Cost: BDT 6.50 Crore (approximately)." },
    { label: "Member", value: "Narayanganj Chamber of Commerce and Industry (NCCI), Bangladesh Sustainable & Renewable Energy Association (BSREA)" },
];
...
const galleryImages = [
  ...
  { src: "https://placehold.co/300x300.png", alt: "Gallery Image 3", hint: "wind turbine field" },
...
export default function AboutPage() {
  return (
    <div className="flex flex-col">
       <PageHeader title="About Us" bgClassName="bg-[#33A667]" />
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 space-y-20">
        ...
        <section id="company-history">
            <h2 className="text-3xl font-bold font-headline mb-2 text-center flex items-center justify-center gap-4"><History className="h-8 w-8 text-primary" /> Our History</h2>
            ...
            <div className="md:hidden space-y-8">
                {coreValues.map((value, index) => (
                    <div key={index} className="bg-white rounded-lg shadow-xl p-4 flex flex-col items-center">
                         ...
                         <h3 className={`text-xl font-bold ${value.color === 'green' ? 'text-green-600' : 'text-blue-900'}`}>{value.title}</h3>
            ...
            <Card>
                <CardHeader className="text-center">
                    <CardTitle className="text-3xl font-bold font-headline flex items-center justify-center gap-4">
                        <Building className="h-8 w-8 text-primary" /> Company Information
                    </CardTitle>
                            ...
                            <tbody className="divide-y">
                                {companyInfo.map((info, index) => (
                                    <tr key={index} className="divide-x">
                                        ...
                                        <td className="p-4 w-2/3 text-muted-foreground">{info.value}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
        ...
        <section id="media-gallery">
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-3xl font-bold font-headline flex items-center justify-center gap-4">
                <Camera className="h-8 w-8 text-primary" /> Media and Gallery
              </CardTitle>
        ...
        <section id="certifications">
            <Card className="bg-muted/50">
                <CardHeader className="text-center">
                   <CardTitle className="text-3xl font-bold font-headline flex items-center justify-center gap-4"><BadgeCheck className="h-8 w-8 text-primary" /> Certifications & Affiliations</CardTitle>
