...
const faqs = [
    ...
    { q: "What is the warranty on your products?asd", a: "Our solar panels come with a 25-year performance warranty, and inverters have a 10-year warranty. All installations are covered by a 5-year workmanship warranty." },
...
export default function ContactUsPage() {
  ...
  return (
    <div className="flex flex-col">
       <PageHeader title="Contact Us" bgImage="/contactus.jpg" />
            ...
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  />
                  <Button type="submit" className="w-full md:w-auto bg-gradient-primary hover:opacity-90">Submit Inquiry</Button>
                </form>
              </Form>
            </CardContent>
          </Card>
        ...
        <div className="space-y-8">
           <Card>
            ...
            <CardContent className="space-y-4">
                 <Button variant="outline" className="w-full justify-start gap-3 bg-gradient-primary text-primary-foreground hover:opacity-90 hover:text-primary-foreground"><BookOpen /> Documentation Hub</Button>
                 <Button variant="outline" className="w-full justify-start gap-3 bg-gradient-primary text-primary-foreground hover:opacity-90 hover:text-primary-foreground"><Bot /> Chat with our AI Assistant</Button>
            </CardContent>
           </Card>
