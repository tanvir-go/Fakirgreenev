            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <motion.div variants={itemVariants}>
                <Card className="overflow-hidden group h-full flex flex-col hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <CardHeader>
                        <CardTitle>Fakir Green Leaders Visit Datai</CardTitle>
                    </CardHeader>
                    <CardContent className="flex-grow">
                        <p className="text-muted-foreground">Fakir Green Energy and EV Ltd company's Chairman and Director visited Datai Motor company in China.</p>
                    </CardContent>
                </Card>
              </motion.div>
              <motion.div variants={itemVariants}>
                <Card className="overflow-hidden group h-full flex flex-col hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <CardHeader>
                        <CardTitle>Solar Partnership with Haier</CardTitle>
                    </CardHeader>
                    <CardContent className="flex-grow">
                        <p className="text-muted-foreground">Business Partnership Agreement is signed with Haier Energy Technology Co., China for Solar EPC projects in Bangladesh.</p>
                    </CardContent>
                </Card>
              </motion.div>
            </div>
