...
export default function ProjectsPage() {
  return (
    <div className="flex flex-col">
      <PageHeader title="Completed Project List" bgImage="/projects.jpg" />
      <div className="py-16 md:py-24 space-y-16">
        <section className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold font-headline text-gradient">Projects successfully completed by GESBD</h2>
        ...
        <section className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold font-headline text-gradient">Projects successfully completed by STBD</h2>
            <div className="w-24 h-1 bg-primary mx-auto mt-4 mb-6"></div>
            <p className="mt-4 text-lg text-muted-foreground max-w-4xl mx-auto text-justify">
